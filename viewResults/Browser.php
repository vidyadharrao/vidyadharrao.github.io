...
echo "</form>";
if(strlen($GTfile))printf("<a href=\"Browser.php?filename=%s&pageno=%d&gt=%s\"> <b> <<< </b> </a> &nbsp;&nbsp;",$inputfile,$page-1,$GTfile);
else printf("<a href=\"Browser.php?filename=%s&pageno=%d\"> <b> <<< </b></a> &nbsp;&nbsp;",$inputfile,$page-1);
echo "<b>Query:".$page."</b>";
if(strlen($GTfile))printf("<a href=\"Browser.php?filename=%s&pageno=%d&gt=%s\"><b> >>> </b> </a> &nbsp;&nbsp;",$inputfile,$page+1,$GTfile);
else printf("&nbsp;&nbsp; <a href=\"Browser.php?filename=%s&pageno=%d\"> <b> >>> </b> </a> ",$inputfile,$page+1);
echo "<br>";
